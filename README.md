# Basic React app with a switch to swap between ESRI and GoogleMaps API.
Intent is to give the user a dragable marker that let's the user save an identified point.
